...
import { Container,LikesField } from './styles';
...
export const Post: React.FC<PostProps> = ({image,text,user, likesNumber}) => {
  return (
    <Container>
      <span>news written by {user}</span>
      <img src={image} alt={`notice send for ${user}`} />
      <p>{text}</p>
